						...
						<tbody>
							{tutorBooking?.map((tbook, index) => (
								...
								>
									...
									<td className="px-2 py-2 border-r-2">{tbook?.subject}</td>
									<td className="px-2 py-2 border-r-2">
										{tbook?.student_class}
									</td>
									<td className="px-2 py-2 border-r-2">
									...
									<td className="px-2 py-2 text-center border-r-2">
										{tbook?.isAccepted == null
											? "Pending"
											: tbook?.isAccepted == false
											? "Rejected"
											: tbook?.isAccepted == true
											? "Accepted"
											: ""}
									</td>
									<td className="px-2 py-2 text-center border-r-2">
										<button
											onClick={() => handleAdminBtn(tbook?._id, "approve")}
											type="button"
											...
											disabled={tbook?.isAccepted}
										>
											<GrValidate className="gr-icon w-4 h-4 mr-2" />
											Approve
										</button>
										<button
											onClick={() => handleAdminBtn(tbook?._id, "deny")}
											type="button"
											...
											disabled={tbook?.isAccepted ? false : true}
										>
