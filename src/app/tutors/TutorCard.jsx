...
const TutorCard = ({ tutorData }) => {
  ...
  const { email, name, photoURL } = tutorData || {};
  return (
    <div className="flex card card-compact w-full bg-base-100 box-shadow-custom group" data-aos="zoom-in">
        <figure className='rounded-t-xl'>
          <Image width={384} height={384} className='overflow-hidden h-96 w-full object-cover rounded-t-xl transition duration-300 group-hover:scale-110' src={photoURL} alt={`${name}'s Image`} />
        </figure>
