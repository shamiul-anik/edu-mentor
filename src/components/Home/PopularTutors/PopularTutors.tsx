...
const PopularTutors = () => {
	...
	return (
		<section className="max-w-7xl mx-auto mt-12 lg:mt-32 p-4 md:px-0">
			...
			<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 mt-8">
				{
					mentorData?.map((data: Tutor) => (<PopularTutorCard key={data._id} data={data}></PopularTutorCard>))
				}
			</div>
