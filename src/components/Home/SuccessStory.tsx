		...
		<section className="max-w-7xl mx-auto mt-12 lg:mt-32 p-4 md:px-0">
			...
			<div data-aos="fade-up" ref={sliderRef} className="keen-slider lg:h-[300px] md:h-[400px] sm:h-[400px] custom-box-shadow rounded-md">
				<div className="keen-slider__slide number-slide rounded-lg lg:flex">
					<Image className='object-cover h-[267px] max-sm:mx-auto max-md:mx-auto mx-4 my-4 rounded-l-full rounded-t-full' src={manImage1} alt='Image of John Smith' placeholder='blur' width={"200"} />
					<div className="w-[80%] mr-4 mx-auto">
				...
				<div className="keen-slider__slide number-slide rounded-lg lg:flex">
					<Image className='object-cover h-[267px] max-sm:mx-auto max-md:mx-auto mx-4 my-4 rounded-l-full rounded-t-full' src={womanImage1} alt='Image of Susan Gray' placeholder='blur' width={"200"} />
					<div className="w-[80%] mr-4 mx-auto">
				...
				<div className="keen-slider__slide number-slide rounded-lg lg:flex">
					<Image className='object-cover h-[267px] max-sm:mx-auto max-md:mx-auto mx-4 my-4 rounded-l-full rounded-t-full' src={manImage2} alt='Image of James Patterson' placeholder='blur' width={"200"} />
					<div className="w-[80%] mr-4 mx-auto">
